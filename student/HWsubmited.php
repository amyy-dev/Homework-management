            ...
            <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <?php
                            ...
                            $sql = "SELECT students.id_std,submittedhomeworks.id_std, id_sub, sub_date,attachment FROM students ,submittedhomeworks WHERE students.id_std= submittedhomeworks.id_std";
                            $result = $conn->query($sql);
