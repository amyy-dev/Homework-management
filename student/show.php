...
$id_hom = isset($_GET['id_hom']) ? $_GET['id_hom'] : null; 
        ...
        <div class="menu-bar">
            <div class="menu">
                <ul class="menu-link">
                    ...
                    <li class="nav-link">
                        <a href="homlist.php" class="active">
                            <i class="bx bx-book-open icon-active"></i>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="stl">
                    ...
                    <button type="button" class="btn" onclick="toggleForm()">Submit your homework</button>
                </div>
                <form method="post" action="submit.php" id="homeworkForm" style="display: none;" enctype="multipart/form-data">
                <!-- Add a hidden input field to pass id_hom -->
                <input type="hidden" name="id_hom" value="<?php echo $id_hom; ?>">
                <br>
                <div class="row">
