...
<body>   
            ...
            <div class="bottom-content">
                ...
                <li class="nav-link">
                    <a href="parametre.php"  class="active">
                        <i class="bx bx-cog icon icon-active"></i>
    ...
    $query = "SELECT * FROM teachers, users WHERE teachers.id_user = users.id_user";
    ...
    if (!$result) {
        ...
        $row = $result->fetch_assoc();
        $firstname = $row['firstname_tchr'];
        $lastname = $row['lastname_tchr'];
        $module = $row['module'];
    }
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $update_query = "UPDATE teachers,users SET firstname_tchr = '$new_firstname', lastname_tchr = '$new_lastname', module = '$new_module' WHERE teachers.id_user = users.id_user";    
    ...
    <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
        ...
        <div class="field input">
          ...
          <input type="text" id="module" name="module" value="<?php echo $module; ?>"><br><br>
        </div>
